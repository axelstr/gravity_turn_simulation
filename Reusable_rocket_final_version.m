...
stage_1 = Stage(158785, 100867, 2766, (3./2)^2*pi, 0.5);
...
first_stage_landing_duration = 10; % Approximate duration for the final landing burn (5-10 seconds)

fuel_left_in_first_stage = 0.1; % At separation. eg. 0.05 for expendable, 0.15 for reusable
burn_rates = [730, 730, 110]; % First stage before turn, first after turn, max of second stage
