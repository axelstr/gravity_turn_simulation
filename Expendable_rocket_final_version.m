...
stage_1 = Stage(137624, 87710, 2747, (3./2)^2*pi, 0.5);
...
fuel_left_in_first_stage = 0.05; % At separation. eg. 0.05 for expendable, 0.15 for reusable
burn_rates = [580, 580, 110]; % First stage before turn, first after turn, max of second stage
